...
public class Ziggurat {
    ...
    private void fightBots(Bot bot, Bot other) {
        ...
        if (bot.fight(other)) {
            currentBot = other;
            if (other.fight(bot)) {
                int bot1 = (bot.strength / 2 == bot.strength) ? 0 : r.nextInt(bot.strength / 2, bot.strength);
                int bot2 = (other.strength / 2 == other.strength) ? 0 : r.nextInt(other.strength / 2, other.strength);
                if (bot1 > bot2) {
